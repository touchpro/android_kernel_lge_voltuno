...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
	...
	{ 1,  192000, ACPUPLL, 5, 2,   CPR_CORNER_SVS,      0, 4 },
	{ 1,  249600, ACPUPLL, 5, 2,   CPR_CORNER_SVS,      0, 4 },
#endif
	...
	{ 1, 1305600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 8 },
	{ 1, 1344000, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 8 },
	{ 1, 1401600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 1, 1497600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 1, 1593600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p2[] = {
	...
	{ 1,  787200, ACPUPLL, 5, 0,   CPR_CORNER_NORMAL,   0, 6 },
	{ 1,  998400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 8 },
	{ 1, 1190400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p4[] = {
	...
	{ 1,  998400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 8 },
	{ 1, 1305600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 8 },
	{ 1, 1344000, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 1, 1401600, ACPUPLL, 5, 0,   CPR_CORNER_TURBO,    0, 9 },
	{ 0 }
};
